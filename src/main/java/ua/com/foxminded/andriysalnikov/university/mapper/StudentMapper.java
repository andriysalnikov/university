...
public class StudentMapper {
    ...
    public StudentDTOWithCourses toDTOWithCourses(Student student) {
        StudentDTOWithCourses studentDTO =
                new StudentDTOWithCourses(student.getId().toString(), student.getFirstName(), student.getLastName());
