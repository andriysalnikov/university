...
public class StudentServiceImpl implements StudentService {
    ...
    public Student getStudentById(Integer id) {
        LOGGER.debug(Messages.TRY_GET_USER_BY_ID, Student.class.getSimpleName(), id);
        ...
        LOGGER.debug(Messages.OK_GET_USER_BY_ID, Student.class.getSimpleName(), id, student);
        return student;
    }

    @Override
    public Student createStudent(User user) {
        LOGGER.debug(Messages.TRY_CREATE_USER, Student.class.getSimpleName());
        Validation.validateUser(user);
        Student createdStudent = studentDAO.createStudent((Student) user).orElseThrow(() -> {
            LOGGER.error(Messages.ERROR_CREATE_STUDENT);
            throw new ServiceException(Messages.ERROR_CREATE_STUDENT);
        });
        LOGGER.debug(Messages.OK_CREATE_USER, Student.class.getSimpleName(), createdStudent);
        return createdStudent;
    }

    @Override
    public Student deleteStudentById(Integer id) {
        LOGGER.debug(Messages.TRY_DELETE_USER_BY_ID, Student.class.getSimpleName(), id);
        Validation.validateId(id);
        ...
        LOGGER.debug(Messages.OK_DELETE_USER_BY_ID, Student.class.getSimpleName(), id, deletedStudent);
        return deletedStudent;
    }

    @Override
    public Student updateStudent(User user) {
        LOGGER.debug(Messages.TRY_UPDATE_USER, Student.class.getSimpleName(), user);
        Validation.validateUser(user);
        Student updatedStudent = studentDAO.updateStudent((Student) user).orElseThrow(() -> {
            LOGGER.error(Messages.ERROR_UPDATE_STUDENT);
            throw new ServiceException(Messages.ERROR_UPDATE_STUDENT);
        });
        LOGGER.debug(Messages.OK_UPDATE_USER, Student.class.getSimpleName(), updatedStudent);
